...
function Features() {
    return (
        <>
            ...
            <section id="second-info" className="flex flex-col md:flex-row gap-4 mx-5 px-10 items-center pt-8 pb-8">
            ...
            <section id="third-info" className="flex flex-col md:flex-row-reverse gap-4 mx-5 px-10 items-center pt-8 pb-8 bg-bgLight">
                <div className="flex flex-col gap-6 md:text-start text-center h-full md:w-1/2">
                    <div className="flex flex-col gap-5 pb-5 max-w-[500px]">
            ...
            <section id="fourth-info" className="flex flex-col md:flex-row gap-4 mx-5 px-10 items-center pt-8 pb-8 bg-bgMid">
                <div className="flex flex-col gap-6 md:text-start text-center h-full md:w-1/2">
                    <div className="flex flex-col gap-5 pb-5 max-w-[500px]">
            ...
            <section id="fifth-info" className="flex flex-col md:flex-row gap-4 mx-5 px-10 items-center pt-8 pb-8 bg-bgDark">
                <div className="flex flex-col gap-6 md:text-start text-center h-full md:w-1/2">
                    <div className="flex flex-col gap-5 pb-5 max-w-[500px]">
            ...
            <section id="sixth-info" className="flex flex-col md:flex-row-reverse gap-4 mx-5 px-10 items-center pt-8 pb-8 bg-bgMid">
                <div className="flex flex-col gap-6 md:text-start text-center h-full md:w-1/2">
                    <div className="flex flex-col gap-5 pb-5 max-w-[500px]">
